                ...
                return (
                  ...
                  >
                    ...
                    <div className="cat-info" style={{ flex: 1, minWidth: 0 }}>
                      <div className="cat-name" style={{ fontSize: '13.5px', fontWeight: 700, color: 'var(--ink)' }}>{c.name}</div>
                    ...
                    <div className="cat-numbers" style={{ textAlign: 'right', flexShrink: 0, marginRight: '8px' }}>
                      <div className="cat-amount" style={{ fontSize: '13px', fontWeight: 700, color: 'var(--ink)' }}>{formatMoney(c.amount || 0)}</div>
