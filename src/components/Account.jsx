...
export default function Account({ email, transactions = [], monthLabelText }) {
  ...
  return (
    <div>
      {/* Topbar containing title and header logout button (Step 24) */}
      <div className="topbar" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '22px' }}>
        <h1>Аккаунт</h1>

        {/* Top-right header icon button with door emoji and soft rose styling (Step 24.2) */}
        <button
          ...
          style={{
            ...
            color: 'var(--expense)',
            border: '1px solid rgba(236, 93, 166, 0.16)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            width: '36px',
      ...
      {/* Profile Header */}
      <div className="card" style={{ padding: '24px', marginBottom: '22px' }}>
      ...
      <div className="card" style={{ padding: '8px 20px', marginBottom: '22px' }}>
