      ...
      <div className="card chart-card g-spending">
        ...
        {pieData.length === 0 ? (
          ...
          <div className="donut-row">
            <div className="donut-wrap glass-donut" onClick={onOpenDashboard} title="Открыть дашборд" style={{ width: 130, height: 130 }}>
              <PieChart width={130} height={130}>
                <Pie data={pieData} dataKey="value" nameKey="name" innerRadius={44} outerRadius={62} paddingAngle={3} stroke="none" cornerRadius={4}>
